...
{
    /// <summary>
    /// Clase para realizar operaciones CRUD sobre la tabla Veterinarios en la base de datos.
    /// Autor: Irving Lopez
    /// Fecha: 24/10/2025
    /// </summary>
    class VeterinarioCRUD
    {
        ...
        /// <summary>
        /// Constructor de la clase VeterinarioCRUD.
        ...
        /// <summary>
        /// Obtiene todos los registros de veterinarios de la base de datos.
        /// Se utiliza un DataTable para almacenar temporalmente los resultados.
        /// </summary>
        /// <returns>DataTable con todos los registros de la tabla Veterinarios.</returns>
        public DataTable ObtenerTodosVeterinarios()
        {
            // Creamos un DataTable vacío donde se almacenarán los veterinarios
            ...
            try
            {
                ...
                {
                    // Consulta SQL para obtener todos los veterinarios
                    ...
                    using (MySqlCommand cmd = new MySqlCommand(query, conexion.GetConnection()))
                    {
                        ...
                        {
                            da.Fill(dtVeterinarios); // Llenamos el DataTable
                        }
                    }

                    // Mensaje opcional para depuración: número de filas obtenidas
                    Console.WriteLine("Cantidad de filas obtenidas: " + dtVeterinarios.Rows.Count);
                }
            }
            catch (Exception ex)
            {
            ...
            // Retornamos el DataTable con los veterinarios
